...
import mediaBackground from '@/public/Dokumentname_farbe_54.jpg'
...
export default function Media() {
    ...
    return(
        <div className='w-full mt-28 mb-28' ref={fancyboxRef}>
            ...
            >
                <PlayIcon className='absolute w-32 h-32 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 '/>
